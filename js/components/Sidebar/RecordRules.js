export default {
    template: `
        ...
        <div class="right-text">
            <p>
                Vous devez avoir compléter le record sans utiliser de hacks (y compris les hacks qui changent la physique du jeu, ie. physics bypass via MegaHack, par contre, "Click Between Frames" est autorisé). 
